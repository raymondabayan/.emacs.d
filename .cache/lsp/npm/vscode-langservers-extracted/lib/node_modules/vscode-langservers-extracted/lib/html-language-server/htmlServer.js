...
function startServer(connection, runtime) {
  ...
  connection.onInitialize(function (params) {
    var _initializationOption, _params$initializatio, _params$initializatio2;
    ...
    var capabilities = {
      ...
      documentRangeFormattingProvider: ((_params$initializatio = params.initializationOptions) === null || _params$initializatio === void 0 ? void 0 : _params$initializatio.provideFormatter) === true,
      documentFormattingProvider: ((_params$initializatio2 = params.initializationOptions) === null || _params$initializatio2 === void 0 ? void 0 : _params$initializatio2.provideFormatter) === true,
        ...
        while (1) {
          switch (_context21.prev = _context21.next) {
            ...
            case 4:
              ...
              return _context21.abrupt("return", (0, formatting_1.format)(languageModes, document, range !== null && range !== void 0 ? range : getFullRange(document), options, settings, enabledModes));
